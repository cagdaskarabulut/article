...
export async function GET() {
  ...
  const script = `SELECT id, project, footer_copyright, footer_company, 
    is_project_type_article, is_project_type_product, is_order_by_menu_active, is_top_menu_active, is_card_design_with_big_image, default_language, main_page_name, is_project_type_modern     
