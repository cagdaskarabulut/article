                ...
                >
                  <>
                    <Grid item xs={12} style={{paddingTop: "0px", paddingLeft: "0px"}}>
                      <h4 style={{margin:"0px", textAlign:"center", color: "rgba(0, 0, 0, 0.6)"}}>{findTitleByUrl()}</h4>
                      {mainData}
                      <LoadMore orderType={orderType} search={search} totalListSize={mainDataSize}/>
                    </Grid>
                    <Grid item xs={6} style={{paddingTop: "0px"}}>
                      <h4 style={{margin:"0px", textAlign:"center", color: "rgba(0, 0, 0, 0.6)"}}>Most Liked Posts</h4>
                      {lastData}
                    </Grid>
                  </>
                </Grid>
