      ...
      {(!isHideWhileLoading || (isHideWhileLoading && !isLoading)) && (
        <div>
          ...
          <Grid
            ...
            spacing={2}
            direction="row"
            justifyContent="center" // Ortalamak için center kullanıldı
            alignItems={contentPosition}
            columns={18}
            style={{
              paddingLeft: "16px",
              paddingRight: "16px",
              margin: "0 auto", // Grid içeriğini ortalamak için eklendi
              maxWidth: "1200px", // İçeriğin genişliğini sınırlandırmak için eklendi
            }}
          >
            {/* 1 column */}
            {isFinallyOneFullContent && (
