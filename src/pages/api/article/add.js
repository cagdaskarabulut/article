...
export default async function handler(request, response) {
  try {
    ...
    const script = `  INSERT INTO public.article (url, title, topics, create_date, title_image, content_image ,video_path, body, is_manuel_page, description, meta_keys, is_active, is_show_in_menu, page_name, is_core_page, is_show_in_banner, is_banner_fit_style, is_banner_stretch_style, banner_order_number, project)
