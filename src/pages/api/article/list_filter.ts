...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const script = `
    SELECT a.id, a.url, a.title, a.topics, a.create_date, a.title_image, a.video_path, a.is_manuel_page, a.description, a.is_active, a.is_show_in_menu, a.page_name, a.is_core_page,is_show_in_banner, is_banner_fit_style, is_banner_stretch_style,banner_order_number,
